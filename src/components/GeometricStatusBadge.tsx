...
const GeometricStatusBadge: React.FC<GeometricStatusBadgeProps> = ({ level }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div className={`w-8 h-8 rounded-xl bg-gradient-to-br ${config.bgGradient} backdrop-blur-sm border ${config.borderColor} flex items-center justify-center shadow-lg`}>
        <IconComponent size={16} className={config.iconColor} strokeWidth={2} />
      </div>
