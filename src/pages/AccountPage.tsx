            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-4">
              ...
              <div className="overflow-x-auto scrollbar-hide px-1 py-2">
                <div className="flex gap-3" style={{ minWidth: 'max-content' }}>
                  ...
                  <button 
                    className="bg-white text-gray-900 border border-gray-300 px-4 py-3 rounded-xl flex flex-col items-center min-w-[90px] shadow-sm hover:bg-gray-50 hover:shadow-md transition-all duration-200"
